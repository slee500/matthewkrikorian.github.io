typer('body')
  ...
  //.line('total 8', 0)
  .line('total 5', 0)
  .line('-rw-r--r--@   1 krikorian  staff     7354 Dec  6 23:09 resume -> <a href="MatthewKrikorianResume.pdf">/docs/resume.pdf</a>', 0)
  ...
  .line()
  .line('I&apos;m an undergraduate student at the <a href="https://ece.illinois.edu/">University of Illinois @Urbana Champaign</a> studying Computer Engineering. My interests lie in both the technology and finance, and keep up with both avidly. I&apos;m currently a junior and will be interning at <a href="https://www.viasat.com/">ViaSat</a> in the Summer.', 0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
  ...
  .line()
  .line('(2015 - 2018) <span style="color: #f08300">->High School Diploma <span style="color: #53d1ed">@BrooklynTechnicalHS</span>', 0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
  ...
  .continue(' <a href="https://www.instagram.com/mattkrikorian/"><img src="instagram.png" alt="Spotify" height="21" width="21"></a>', 0)
