typer('body')
  ...
  .line()
  .line('<span style="color: #f08300">2018 - 2019 -></span> Masters degree in Electrical and Computer Engineering @UIUC', 0)
  .line()
  .line('<span style="color: #f08300">2015 - 2018 -></span> Bachelors degree in Computer Engineering @UIUC', 0)
  .line()
  .line('<span style="color: #f08300">2011 - 2015 -></span> High School Diploma @BrooklynTechnicalHS', 0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
  ...
  .line()
  .line('<span style="color: #f08300">Summer 2018 -></span> Incoming Software Engineering Intern at ViaSat', 0)
  .line()
  .line('<span style="color: #f08300">Summer 2017 -></span> Network Engineering Intern at Verizon', 0)
  .line()
  .line('<span style="color: #f08300">Summer 2016 -></span> Undergraduate Research Assistant at UIUC',0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
