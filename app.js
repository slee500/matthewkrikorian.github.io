typer('body')
  ...
  .line()
  .line('(2018 - 2019) -> <span style="color: #e0d55a">Master&apos;s Degree</span> in Electrical and Computer Engineering <span style="color: #53d1ed">@UIUC</span>', 0)
  .line()
  .line('(2015 - 2018) -> <span style="color: #e0d55a">Bachelor&apos;s Degree</span> in Computer Engineering <span style="color: #53d1ed">@UIUC</span>', 0)
  .line()
  .line('(2015 - 2018) -> <span style="color: #e0d55a">Bachelor&apos;s Degree</span> in Computer Engineering <span style="color: #53d1ed">@BrooklynTechnicalHS</span>', 0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
  ...
  .line()
  .line('(<span style="color: #f08300">Summer 2018</span>)<span style="color: #f08300">-></span> Incoming Software Engineering Intern at ViaSat', 0)
  .line()
  .line('(<span style="color: #f08300">Summer 2017</span>)<span style="color: #f08300">-></span> Network Engineering Intern at Verizon', 0)
  .line()
  .line('(<span style="color: #f08300">Summer 2016</span>)<span style="color: #f08300">-></span> Undergraduate Research Assistant at UIUC',0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
  ...
  .continue(' <a href="https://www.facebook.com/kricketmaster"><img src="facebook.png" alt="Facebook" height="21" width="21"></a>', 0)
  .continue(' <a href="https://open.spotify.com/user/krikorn2"><img src="spotify.png" alt="Spotify" height="21" width="21"></a>', 0)
  .line()
  .line('[<span style="color: #df005e">krikorian</span><span style="color: #e0d55a">@home</span>:</span><span style="color: #53d1ed">~/site</span>]$ </span>', 0)
  .pause(1250)
